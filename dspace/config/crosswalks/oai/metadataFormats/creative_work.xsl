...
<xsl:stylesheet 
	...
	<xsl:template match="/">
		<rdf:RDF 
			xmlns:rdf="http://www.openarchives.org/OAI/2.0/rdf/"
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='creativeWork']/doc:element[@name='accessibilityFeature']/doc:element/doc:element/doc:field[@name='value']">
				<schema:accessibilityFeature><xsl:value-of select="." /></schema:accessibilityFeature>
			</xsl:for-each>
			<xsl:for-each select="doc:metadata/doc:element[@name='creativeWork']/doc:element[@name='accessibilitySummary']/doc:element/doc:element/doc:field[@name='value']">
				<dc:description><xsl:value-of select="." /></dc:description>
			</xsl:for-each>
